-- Preserve immutable customer source artwork when AI/processed artwork is used.
-- Additive and backward compatible: existing enquiries keep source_artwork_path null.
...
begin
  ...
  if found then
    select artwork_path, source_artwork_path, preview_path
      into artwork, source_artwork, preview
    ...
    return jsonb_build_object(
      ...
      'source_artwork_path',source_artwork,
  ...
  return jsonb_build_object(
    ...
    'source_artwork_path',payload->>'source_artwork_path',
