...
const formCopy = {
  en: {
    ...
    preparingEditor: "{t.preparingEditor}",
    designStep: "{t.designStep}",
    reviewStep: "{t.reviewStep}",
    draftPrivacy: "Customer contact details are not stored in this draft.",
    whatsappContinue: "{t.whatsappContinue}",
    ...
    saveDraftError: t.saveDraftError,
    backProduct: "{t.backProduct}",
    reviewButton: "{t.reviewButton}",
    indicativePreview: "indicative preview",
    downloadPreview: "{t.downloadPreview}",
    downloadSettings: "{t.downloadSettings}",
